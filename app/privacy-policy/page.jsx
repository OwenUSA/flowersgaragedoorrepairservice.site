...
const description =
  'Privacy policy for Flowers Garage Door Repair: what we collect when you call, text or request a garage door visit in South Florida, how we use it, and how to request deletion.';
...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      'What Flowers Garage Door Repair collects when you call, text or book a garage door visit in South Florida, and how to request deletion.',
    url: '/privacy-policy/',
    images: ['/img/logo.png'],
  },
};
    ...
    <>
      ...
      <main className="legal">
        <div className="container legal__inner">
          ...
          <p>
            {site.brand} is a mobile garage door repair and installation service operating across
            Miami-Dade, Broward and Palm Beach County, Florida. Our dispatch point is{' '}
            {mainCity.addr1}, {mainCity.name}, FL {mainCity.zip}, and our phone number is{' '}
          ...
          <ul>
            <li>
              <strong>Contact details</strong> you give us: name, phone number, email address and the
              service address where the door is.
            </li>
            <li>
          ...
          <p>
            If you give us your mobile number, we may text you about your appointment: confirmations,
            the technician&rsquo;s arrival window, and follow-up about the work. Message and data
            rates may apply. Reply <strong>STOP</strong> to any message to opt out and{' '}
            <strong>HELP</strong> for help. Consent to receive text messages is never a condition of
            getting service.
          </p>
          ...
          <p>
            ...
            opt-out browser add-on, or adjust your ad settings with Google and Meta. Blocking cookies
            does not affect your ability to call us or book a visit. This is separate from, and does
            not change, the commitment in section 3: your phone number and mobile opt-in data are
          ...
          <p>
            ...
            before acting, and we will respond within the time the applicable law allows. We will not
          ...
          <p>
            ...
            warranty and to satisfy tax and legal requirements, and then we delete or anonymize them.
            Marketing contact details are kept until you opt out. Website analytics data is retained
            according to the settings of the analytics platform.
          </p>
          ...
          <ul>
            ...
            <li>
              Mail: {site.brand}, {mainCity.addr1}, {mainCity.name}, FL {mainCity.zip}
            </li>
          </ul>
        </div>
      </main>

      <Footer variant="plain" bottomPath="/privacy-policy" />
